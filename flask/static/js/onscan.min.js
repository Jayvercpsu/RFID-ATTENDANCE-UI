  ...
  var d = {
    ...
    _handlePaste: function (e) {
      var t = this.scannerDetectionData.options,
        ...
        a = (event.clipboardData || window.clipboardData).getData("text");
      d._isFocusOnIgnoredElement(this) ||
        (e.preventDefault(),
        t.stopPropagation && e.stopImmediatePropagation(),
        t.onPaste.call(this, a, event),
        (n.firstCharTime = 0),
        (n.lastCharTime = 0),
        d._validateScanCode(this, a));
    },
    ...
    isAttachedTo: function (e) {
      return void 0 !== e.scannerDetectionData;
    },
  };
  return d;
});
